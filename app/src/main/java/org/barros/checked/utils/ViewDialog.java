package org.barros.checked.utils;
...
public class ViewDialog {
    ...
    public Dialog showDefaultDialog(Activity activity, String title, String subtitle,
                                    View.OnClickListener yesButton){
        final Dialog dialog = new Dialog(activity);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(false);
        ...
        ok.setOnClickListener(yesButton);
        no.setOnClickListener((view -> {dialog.dismiss();}));
